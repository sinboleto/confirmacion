...
lugar_recepcion = 'en el Palacio Metropolitano'
codigo_vestimenta = 'etiqueta rigurosa (Hombres: Smoking, Mujeres: Vestimenta negra - Vestido largo u otro)'
link_mesa_regalos = 'https://evento.uniko.co/pamelasalasydiegovelarde/'
link_soporte = 'https://wa.link/kzby9c'
pagina_web = 'https://www.sinboleto.com.mx'
